...
Implementing blockchain to assist in achieving decentralized federated learning with a focus on addressing the challenges of resource allocation on local and edge devices and straggler mitigation in a hierarchical system.
- #### Robust Federated Learning: Attacks and Defenses.
- #### Robust Data Similarity Evaluation.
